...
public class USSDController implements USSDInterface, USSDApi {
   ...
   */
  public void callUSSDInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map,
   ...
   * @param callbackInvoke  a callback object from return answer
   */
  public void callUSSDOverlayInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map,
      CallbackInvoke callbackInvoke) {
  ...
  public void callUSSDInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map,
      CallbackInvoke callbackInvoke) {
    this.sendSign = false;
   ...
   */
  @SuppressLint("MissingPermission")
  public void callUSSDOverlayInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map,
      CallbackInvoke callbackInvoke) {
    this.callbackInvoke = callbackInvoke;
    this.map = map;
  ...
  private static void openSettingsAccessibility(final Activity activity) {
    ...
    String name = applicationInfo.labelRes == 0 ? applicationInfo.nonLocalizedLabel.toString()
